...
patterns \cite{harris_glossary_1979}. Despite the prominent role of
microsculpturing in ant identification, however, almost nothing is known about
how these patterns evolved or their function. Similar microsculpturing patterns
in other organisms have been found to reduce abrasion, increase stiffness, and
perform as structural antibiotics \cite{zhiwu_erosion_2012, han_efficient_2015,
    rees_form_1975, chung_impact_2007,hasan_selective_2013}. Developing a better
understanding of the function of microsculpturing in ants could provide insight
into their evolution and biology as well as lead to the development of
bio-inspired technologies \cite{penick_comparative_2022}.
...
five categories: smooth, striate, punctate, reticulate, and tuberous. Using
these categories to classify 11,722 ant species, we found that the earliest ants
were likely smooth and that cuticle microsculpturing independently evolved later
in multiple lineages. An even simpler classification scheme is to divide ants
into only two categories: smooth and rough. Because microsculptuing has evolved
numerous times in ants, this binary classification scheme is sufficient to
detect conditions that select for any sculpturing at all compared to a smooth
state.
...
\begin{figure}
    ...
    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/sr103.png}
    \end{subfigure}
    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/sr111.png}
    \end{subfigure}
    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/ss105.png}
    \end{subfigure}
    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/ss107.png}
    \end{subfigure}

    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/heat103.png}
    \end{subfigure}
    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/heat111.png}
    \end{subfigure}
    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/heat105.png}
    \end{subfigure}
    \begin{subfigure}{\segmentedsubwidth}
        \includegraphics[width=1\linewidth]{/home/ngardn10/projects/cuticulus/paper/assets/images/kviews/heat107.png}
    \end{subfigure}
...
\ref{fig:kviews_segmented}. A training set of 500 patches for background, 500
patches for rough, and 500 patches for smooth are applied with patch sizes of
15x15 and 19x19. These patches are extracted from two rough and two smooth
images. The K-views algorithm converges early although we set the maximum number
of iterations to be 1000.
